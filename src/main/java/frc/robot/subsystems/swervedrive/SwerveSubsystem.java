...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    SmartDashboard.putString("Coral/Elevator/Robot Pose", "X: " + getPose().getX() + ", Y: " + getPose().getY() + ", Heading: " + getPose().getRotation().getDegrees() + "°");
      ...
      // SmartDashboard.putNumber("Coral/Elevator/Robot Heading",
      // getPose().getRotation().getDegrees());
      // String out = String.format("x:%.2f , y:%.2f, r:%.2f", getPose().getX(), getPose().getY(),
      //     getPose().getRotation());
      String out =   "X" + getPose().getX() + 
      ", Y" + getPose().getY()+ ", R" + getPose().getRotation().getDegrees()
      ;
